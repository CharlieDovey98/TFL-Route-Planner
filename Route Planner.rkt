...
(definemore (Walthamstow_Central "Walthamstow Central") (Blackhorse_Road "Blackhorse Road") (Tottenham_Hale "Tottenham Hale") (Seven_Sisters "Seven Sisters") (Finsbury_Park "Finsbury Park")
  ...
  ;  Northern Line Stations ^^^^              Northern Line Stations vvvvv
  )
...
(define londonunderground (list (list Walthamstow_Central Blackhorse_Road) (list Blackhorse_Road Tottenham_Hale) (list Tottenham_Hale Seven_Sisters) (list Seven_Sisters Finsbury_Park)
                                ...
                                ;  Victoria Line part of the graph ^^^^              Circle Line part of the graph vvvvv
                                ...
                                ;  Circle Line part of the graph ^^^^              Piccadilly Line part of the graph vvvvv
                                ...
                                (list Green_Park Hyde_Park_Corner) (list Hyde_Park_Corner Knightsbridge) (list Knightsbridge South_Kensington) (list South_Kensington Gloucester_Road)
                                ...
                                (list Hammersmith Barons_Court) (list Barons_Court Earl_s_Court) (list Earl_s_Court Gloucester_Road) (list Gloucester_Road South_Kensington)
                                ...
                                ;  Piccadilly Line Stations ^^^^              District Line Stations vvvvv
                                (list Upminster Upminster_Bridge) (list Upminster_Bridge Hornchurch) (list Hornchurch Elm_Park) (list Elm_Park Dagenham_East) (list Dagenham_East Dagenham_Heathway)
                                (list Dagenham_Heathway Becontree) (list Becontree Upney) (list Upney Barking) (list Barking East_Ham) (list East_Ham Upton_Park) (list Upton_Park Plaistow)
                                (list Plaistow West_Ham) (list West_Ham Bromley-by-Bow) (list Bromley-by-Bow Bow_Road) (list Bow_Road Mile_End) (list Mile_End Stepney_Green)
                                (list Stepney_Green Whitechapel) (list Whitechapel Aldgate_East) (list Aldgate_East Tower_Hill) (list Tower_Hill Monument) (list Monument Cannon_Street)
                                (list Cannon_Street Mansion_House) (list Mansion_House Blackfriars) (list Blackfriars Temple) (list Temple Embankment) (list Embankment Westminster)
                                (list Westminster St_James_s_Park) (list St_James_s_Park Victoria) (list Victoria Sloane_Square) (list Sloane_Square South_Kensington)
                                (list South_Kensington Gloucester_Road) (list Earl_s_Court High_Street_Kensington)
                                (list High_Street_Kensington Notting_Hill_Gate)
                                (list Notting_Hill_Gate Bayswater) (list Bayswater Paddington) (list Paddington Edgware_Road) (list Edgware_Road Paddington) (list Paddington Bayswater)
                                (list Bayswater Notting_Hill_Gate) (list Notting_Hill_Gate High_Street_Kensington) (list High_Street_Kensington Earl_s_Court) (list Earl_s_Court Kensington_Olympia)
                                (list Kensington_Olympia Earl_s_Court) (list Earl_s_Court West_Kensington) (list West_Kensington Barons_Court) (list Barons_Court Hammersmith)
                                ...
                                (list Hammersmith Barons_Court) (list Barons_Court West_Kensington) (list West_Kensington Earl_s_Court) (list Earl_s_Court West_Brompton)
                                ...
                                (list East_Putney Southfields) (list Southfields Wimbledon_Park) (list Wimbledon_Park Wimbledon) (list Wimbledon Wimbledon_Park) (list Wimbledon_Park Southfields)
                                (list Southfields East_Putney) (list East_Putney Putney_Bridge) (list Putney_Bridge Parsons_Green) (list Parsons_Green Fulham_Broadway)
                                (list Fulham_Broadway West_Brompton) (list West_Brompton Earl_s_Court) (list Gloucester_Road South_Kensington)
                                (list South_Kensington Sloane_Square) (list Sloane_Square Victoria) (list Victoria St_James_s_Park) (list St_James_s_Park Westminster) (list Westminster Embankment)
                                (list Embankment Temple) (list Temple Blackfriars) (list Blackfriars Mansion_House) (list Mansion_House Cannon_Street) (list Cannon_Street Monument)
                                (list Monument Tower_Hill) (list Tower_Hill Aldgate_East) (list Aldgate_East Whitechapel) (list Whitechapel Stepney_Green) (list Stepney_Green Mile_End)
                                ...
                                ;  Central Line Stations ^^^^              Hammersmith & City Line Stations vvvvv
                                (list Hammersmith Goldhawk_Road) (list Goldhawk_Road Shepherd_s_Bush_Market) (list Shepherd_s_Bush_Market Wood_Lane) (list Wood_Lane Latimer_Road)
                                (list Latimer_Road Ladbroke_Grove) (list Ladbroke_Grove Westbourne_Park) (list Westbourne_Park Royal_Oak) (list Royal_Oak Paddington) (list Paddington Edgware_Road)
                                (list Edgware_Road Baker_Street) (list Baker_Street Great_Portland_Street) (list Great_Portland_Street Euston_Square) (list Euston_Square Kings_Cross_St_Pancras)
                                (list Kings_Cross_St_Pancras Farringdon) (list Farringdon Barbican) (list Barbican Moorgate) (list Moorgate Liverpool_Street) (list Liverpool_Street Aldgate_East)
                                (list Aldgate_East Whitechapel) (list Whitechapel Stepney_Green) (list Stepney_Green Mile_End) (list Mile_End Bow_Road) (list Bow_Road Bromley-by-Bow)
                                (list Bromley-by-Bow West_Ham) (list West_Ham Plaistow) (list Plaistow Upton_Park) (list Upton_Park East_Ham) (list East_Ham Barking) (list Barking East_Ham)
                                (list East_Ham Upton_Park) (list Upton_Park Plaistow) (list Plaistow West_Ham) (list West_Ham Bromley-by-Bow) (list Bromley-by-Bow Bow_Road) (list Bow_Road Mile_End)
                                (list Mile_End Stepney_Green) (list Stepney_Green Whitechapel) (list Whitechapel Aldgate_East) (list Aldgate_East Liverpool_Street) (list Liverpool_Street Moorgate)
                                (list Moorgate Barbican) (list Barbican Farringdon) (list Farringdon Kings_Cross_St_Pancras) (list Kings_Cross_St_Pancras Euston_Square)
                                (list Euston_Square Great_Portland_Street) (list Great_Portland_Street Baker_Street) (list Baker_Street Edgware_Road) (list Edgware_Road Paddington)
                                (list Paddington Royal_Oak) (list Royal_Oak Westbourne_Park) (list Westbourne_Park Ladbroke_Grove) (list Ladbroke_Grove Latimer_Road) (list Latimer_Road Wood_Lane)
                                (list Wood_Lane Shepherd_s_Bush_Market) (list Shepherd_s_Bush_Market Goldhawk_Road) (list Goldhawk_Road Hammersmith)
                                ;  Hammersmith & City Line Stations ^^^^              Jubilee Line Stations vvvvv
                                ...
                                (list Bond_Street Green_Park)
                                (list Green_Park Westminster) (list Westminster Waterloo) (list Waterloo Southwark) (list Southwark London_Bridge) (list London_Bridge Bermondsey)
                                (list Bermondsey Canada_Water) (list Canada_Water Canary_Wharf) (list Canary_Wharf North_Greenwich) (list North_Greenwich Canning_Town)
                                (list Canning_Town West_Ham) (list West_Ham Stratford) (list Stratford West_Ham) (list West_Ham Canning_Town) (list Canning_Town North_Greenwich)
                                (list North_Greenwich Canary_Wharf) (list Canary_Wharf Canada_Water) (list Canada_Water Bermondsey) (list Bermondsey London_Bridge) (list London_Bridge Southwark)
                                (list Southwark Waterloo) (list Waterloo Westminster) (list Westminster Green_Park) (list Green_Park Bond_Street) (list Bond_Street Baker_Street)
                                (list Baker_Street St_John_s_Wood) (list St_John_s_Wood Swiss_Cottage) (list Swiss_Cottage Finchley_road) (list Finchley_road West_Hampstead)
                                (list West_Hampstead Kilburn) (list Kilburn Willesden_Green) (list Willesden_Green Dollis_Hill) (list Dollis_Hill Neasden) (list Neasden Wembley_Park)
                                (list Wembley_Park Kingsbury) (list Kingsbury Queensbury) (list Queensbury Canons_Park) (list Canons_Park Stanmore)
                                ;  Jubilee Line Stations ^^^^              Metropolitan Line Stations vvvvv
                                (list Aldgate Liverpool_Street) (list Liverpool_Street Moorgate) (list Moorgate Barbican) (list Barbican Farringdon) (list Farringdon Kings_Cross_St_Pancras)
                                (list Kings_Cross_St_Pancras Euston_Square) (list Euston_Square Great_Portland_Street) (list Great_Portland_Street Baker_Street) (list Baker_Street Finchley_Road)
                                (list Finchley_Road Wembley_Park) (list Wembley_Park Preston_Road) (list Preston_Road Northwick_Park) (list Northwick_Park Harrow-on-the-Hill)
                                (list Harrow-on-the-Hill West_Harrow) (list West_Harrow Rayners_Lane) (list Rayners_Lane Eastcote) (list Eastcote Ruislip_Manor) (list Ruislip_Manor Ruislip)
                                (list Ruislip Ickenham) (list Ickenham Hillingdon) (list Hillingdon Uxbridge) (list Uxbridge Hillingdon) (list Hillingdon Ickenham) (list Ickenham Ruislip)
                                (list Ruislip Ruislip_Manor) (list Ruislip_Manor Eastcote) (list Eastcote Rayners_Lane) (list Rayners_Lane West_Harrow) (list West_Harrow Harrow-on-the-Hill)
                                ...
                                (list Amersham Chalfont_&_Latimer) (list Chalfont_&_Latimer Chorleywood) (list Chorleywood Rickmansworth) (list Rickmansworth Moor_Park) (list Moor_Park Northwood)
                                (list Northwood Northwood_Hills) (list Northwood_Hills Pinner) (list Pinner North_Harrow) (list North_Harrow Harrow-on-the-Hill)
                                ...
                                (list Finchley_Road Baker_Street) (list Baker_Street Great_Portland_Street) (list Great_Portland_Street Euston_Square) (list Euston_Square Kings_Cross_St_Pancras)
                                (list Kings_Cross_St_Pancras Farringdon) (list Farringdon Barbican) (list Barbican Moorgate) (list Moorgate Liverpool_Street) (list Liverpool_Street Aldgate)
                                ;  Metropolitan Line Stations ^^^^              Northern Line Stations vvvvv
                                ...
                                (list Leicester_Square Tottenham_Court_Road) (list Tottenham_Court_Road Goodge_Street) (list Goodge_Street Warren_Street) (list Warren_Street Euston)
                                ...
                                (list Euston Warren_Street) (list Warren_Street Goodge_Street) (list Goodge_Street Tottenham_Court_Road) (list Tottenham_Court_Road Leicester_Square)
                                ...
                                (list Angel Kings_Cross_St_Pancras) (list Kings_Cross_St_Pancras Euston) (list Euston Camden_Town) (list Camden_Town Chalk_Farm) (list Chalk_Farm Belsize_Park)
                                ...
                                (list Kentish_Town Camden_Town) (list Camden_Town Euston) (list Euston Kings_Cross_St_Pancras) (list Kings_Cross_St_Pancras Angel) (list Angel Old_Street)
...
;(definemore 
;(Oakhymbmhjjwood "Oakwood") (Oafdkgjnmwood "Oakwood") (Oakdfcxdgwood "Oakwood") (Oakasdcmjmjwood "Oakwood") (Oakdfkkewood "Oakwood") (Oakwdgfgaotgtfrod "Oakwood") (Oakwkagfriujood "Oakwood")
;(Oakhymbmhjjwood "Oakwood") (Oafdkgjnmwood "Oakwood") (Oakdfcxdgwood "Oakwood") (Oakasdcmjmjwood "Oakwood") (Oakdfkkewood "Oakwood") (Oakwdgfgaotgtfrod "Oakwood") (Oakwkagfriujood "Oakwood")
;(Oakhymbmhjjwood "Oakwood") (Oafdkgjnmwood "Oakwood") (Oakdfcxdgwood "Oakwood") (Oakasdcmjmjwood "Oakwood") (Oakdfkkewood "Oakwood") (Oakwdgfgaotgtfrod "Oakwood") (Oakwkagfriujood "Oakwood")  
;)
...
(define base-frame (new frame% [label "London Underground Route Planner"] [width 400] [height 700] ))
(define map-frame (new frame% [label "TFL Underground Map"] [width 400] [height 400] ))
(new canvas% [parent map-frame] [paint-callback (λ (canvas dc) (send dc draw-bitmap (read-bitmap "/Users/charliedovey/Desktop/Uni/Year 1/Programming/Racket/block3/Tube-map-image.png") 0 0))])

(define globalmessage (new message% [parent base-frame] [label "Please select your start and end Station\nThen click 'Confirm' to see your route"] ))                                                                                                                                        
(define inputpanel (new vertical-panel% [parent base-frame] [alignment '(center center)] ))


(define combinationbox-choices (remove-duplicates (flatten londonunderground)))
(define start-location (new combo-field% [parent inputpanel] [label "Start Location:"] [init-value "Choose Start Location Here"] [choices combinationbox-choices]))
(define end-location (new combo-field% [parent inputpanel] [label "End Location:"] [init-value "Choose End Location Here"] [choices combinationbox-choices] ))

(define mappanel (new vertical-panel% [parent base-frame][min-width 300][min-height 300]))
(define londonmap (new map-widget% [parent mappanel][position london][zoom 11]))

(define buttonpanel (new horizontal-panel% [parent inputpanel][alignment '(center top)] [min-width 300][min-height 50] ))
(define outputpanel (new vertical-panel% [parent base-frame][alignment '(center top)][min-width 300][min-height 300] ))

(define tfl-map (new button% [parent buttonpanel] [label "TFL Map"] [ callback (λ (button event)(send map-frame show #t))] ))

(define clear (new button% [parent buttonpanel][label "Clear"][ callback (λ (button event)(send start-location set-value "")(send end-location set-value "")
                                                                           (send data-confirm set-label "Travel Planner Data:")
                                                                           (send data-output set-label "\nStart location\n\n->Stops\n\n->End location"))] ))

(define switch (new button% [parent buttonpanel][label "Switch"][ callback (λ (button event) (let ([x (list (send start-location get-value) (send end-location get-value))])
                                                                                                      (send start-location set-value (second x))(send end-location set-value(first x))))] ))
(define confirm (new button% [parent buttonpanel] [label "Confirm"][callback (λ (button event)
                                                                               (println(string-join (dfsshorter (send start-location get-value) (send end-location get-value)) " -> ") ) (println (dfsshorter start-location end-location))
                                                                               (send data-confirm set-label "Route for your travel:")
                                                                               (send data-output set-value (string-join (dfsshorter (send start-location get-value) (send end-location get-value)) "\n -> ")))] ))
                                                                                                                                                          
(define data-confirm (new message% [parent outputpanel] [label "Travel Data:"] [min-width 200] [min-height 10]))
(define data-output (new text-field% [parent outputpanel] [label "\nStart location\n\n->Stops\n\n->End location"] [min-width 250][min-height 300] ))
(define globalmessage2 (new message% [parent base-frame] [label (string-append "Up to date as of "(date->string (seconds->date (current-seconds))))] ))
...
(define (dfsshorter x y) (depthfirstsearch x y (list )))

(define (depthfirstsearch x y workinglist)
  (cond
    [(equal? x y) (list y)]
    [(set-member? workinglist x) #f]
    [else
     (let ((route (dfshelper (children x londonunderground)y (set-add workinglist x))))
       (if (equal? route #f) #f (cons x route)))] ))


(define (dfshelper x y workinglist)
  (cond
    [(empty? x) #f]
    [else
     (let ((route (depthfirstsearch (first x) y workinglist)))
       (if (equal? route #f) (dfshelper (rest x) y workinglist) route))] ))
